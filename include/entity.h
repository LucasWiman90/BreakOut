...
//This is an abstract base class to represent any graphical entity on the screen
class entity{
protected:
    sf::Sprite sprite;      //Should probably not be protected. Child classes can see it.
...
public:
    ...
    //The draw member function will cause the updated object to be displayed
    ...
    //Helper function to get the centre of the sprite
...
//Abstract base class to represent graphical entities which can move around on the screen
